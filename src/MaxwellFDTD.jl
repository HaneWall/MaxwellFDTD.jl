module MaxwellFDTD
    ...
    export Fields1D, Fields2D, MaterialFields1D, LorentzFields1D, DrudeFields1D, TunnelFields1D, Fields3D
    ...
    export GridCoefficients1D, GridCoefficients3D,  GridCoefficients1D_w_CPML, GridCoefficients2D_w_CPML, GridCoefficients3D_WIP, GridCoefficients3D_w_CPML, FieldIonizationCoefficients1D
    ...
    export LorentzMedium1D, StaticMedium1D, TunnelMedium1D, DrudeMedium1D, StaticMedium2D, StaticMedium3D
    export mytukey
